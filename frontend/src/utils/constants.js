...
export const CALL_METHODS = ['Gọi điện', 'Nhắn Zalo', 'Gặp trực tiếp', 'Gửi báo giá', 'Email', 'Khác'];
export const CALL_STATUSES = ['Kết thúc', 'Chờ phản hồi', 'Đang tiếp tục'];
...
export const CALL_STATUS_COLORS = {
  'Kết thúc': 'badge-gray',
  'Chờ phản hồi': 'badge-yellow',
  'Đang tiếp tục': 'badge-blue',
};
